...
This guide provides comprehensive documentation for the **error-handling** skill in the custom-plugin-nodejs plugin.
...
```bash
# Invoke the skill
claude "error-handling - [your task description]"

# Example
claude "error-handling - analyze the current implementation"
```
...
def implement_error_handling(input_data):
    """
